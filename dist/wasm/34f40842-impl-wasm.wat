(module
 ...
 (data $11 (i32.const 1600) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\01\t")
 (export "sumArrayWasm" (func $src/benchmarks/sum-array/34f40842-impl-wasm/sumArrayWasm))
 ...
 (func $src/benchmarks/sum-array/34f40842-impl-wasm/sumArrayWasm (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i64)
  (local $3 i32)
  (local $4 i32)
